...
const urls = [];
urls.push('/'); urls.push('/tools/'); urls.push('/cities/'); urls.push('/guides/labor-arbitration-evidence-checklist/'); urls.push('/guides/overtime-pay-evidence-template/'); urls.push('/templates/'); urls.push('/sponsor/'); urls.push('/contact/'); urls.push('/privacy/'); urls.push('/terms/');
